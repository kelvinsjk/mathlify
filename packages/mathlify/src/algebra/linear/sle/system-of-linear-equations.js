...
export class SLE {
	...
	/**
	 * @overload
	 * @param {undefined} [options] - options object defaulting to `{returnFraction: false}`
	 * @returns {string[]}
	 */
	/**
	 * solves the system of linear equations, returning an array of strings "x = ..."
	 * @param {{returnFraction?: true}|undefined} [options] - options object defaulting to `{returnFraction: false}`
