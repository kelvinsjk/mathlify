 ...
 * @param {{aligned?: boolean, step2Preamble?: string}} [options]
 ...
 * @param {{den: Polynomial|number|Fraction|[Polynomial, number|Fraction], aligned?: boolean, step2Preamble?: string}} options
 * @returns {{y: RationalFn, dydx: RationalFn, num: Polynomial, den: Polynomial, denPow: Fraction, working: string}}
 */
/**
 * @param {RationalFn|Polynomial} quotient
 * @param {{den?: Polynomial|number|Fraction|[Polynomial, number|Fraction], aligned?: boolean, step2Preamble?: string}|undefined} options
 * @returns {{y: RationalFn, dydx: RationalFn, num: Polynomial, den: Polynomial, denPow: Fraction, working: string}}
 */
...
export function quotientRuleWorking(quotient, options) {
  ...
  return {
    ...
    working: `\\frac{${num}}{${den}} \\\\\n${eq}${
      options?.step2Preamble ?? ""
    } \\frac{${du.times(v)} - \\left( ${u.times(dv)} \\right)}{${den}}`,
  };
}
