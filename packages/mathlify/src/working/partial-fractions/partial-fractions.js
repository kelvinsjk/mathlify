 ...
 * @param {(Polynomial|string|[string|Polynomial, 2])[]|Polynomial} den - if polynomial provided, then expect reducible polynomial of degree 2. Else expect an array of factors
 * @returns {{working: string, result: Expression}}
 */
export function partialFraction(num, den) {
	/** @type {ExpressionProduct|undefined} */
	let denProd = undefined;
	// handle denominators
