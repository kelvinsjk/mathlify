 ...
 */
export function cubicRoot(cubic: Polynomial | [number, number, number, number], lower?: number | undefined, upper?: number | undefined, precision?: number | undefined): number | Expression;
