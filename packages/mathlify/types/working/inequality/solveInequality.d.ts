 ...
 * @returns {string[]} - the solution as a string
 */
export function solveQuadraticInequality(lhs: Polynomial | Expression, sign?: "<" | ">" | "\\geq" | "\\leq" | "geq" | "leq" | undefined, rhs?: number | import("../../core/fraction.js").Fraction | import("../../core/index.js").Expression | Polynomial | undefined): string[];
