...
still requires some hacky markup. As of now we are only restricted to inline math so
displayed math will also require non-ideal markup.

I'm interested to see how this experiment will end up. I still think the math-in-js approach
is still the best I can think of for highly dynamic content like in an app, but for blogging
this approach might be a good compromise.
