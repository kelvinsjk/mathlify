<script context="module" lang="ts">
	...
	import { keyboardOptions, numberLayer, } from './keyboardLayout';
...
<script lang="ts">
	...
	let mathliveElement//: MathfieldElement;
	...
	onMount(async () => {
		...
		mathliveElement.setOptions({
			...
			onFocus: focusScroll,
			customVirtualKeyboardLayers: numberLayer
		});
		...
		mathliveElement.setValue(value === undefined ? '\\bigstar' : value.toString());
	});
