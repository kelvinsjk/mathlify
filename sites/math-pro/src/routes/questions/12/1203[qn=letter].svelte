<script lang="ts">
	...
	import {JSONParse, Fraction, type Term, type Expression, Vector, SquareRoot} from 'mathlify';
	import {checkAnswer} from './_logic/checkAnswer';
	import {qnProgress} from '$lib/progress/stores';
	...
	// edit this
	import {qnLogics} from './_logic/1203';
	const regex = /^1203[a-d]$/;
	// edit this
