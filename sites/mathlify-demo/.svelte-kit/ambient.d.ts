...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_mathlifier: string;
	...
	export const npm_package_dependencies_highlightjs_svelte: string;
	...
	export const npm_package_devDependencies_mathlify: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_mathlifier: string;
		USER: string;
		...
		npm_package_dependencies_highlightjs_svelte: string;
		...
		npm_package_devDependencies_mathlify: string;
