...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_mathlify: string;
	...
	export const npm_package_dependencies_mathlifier: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GDK_BACKEND: string;
		npm_package_dependencies_mathlify: string;
		...
		npm_package_dependencies_mathlifier: string;
		SHELL: string;
		NODE_PATH: string;
