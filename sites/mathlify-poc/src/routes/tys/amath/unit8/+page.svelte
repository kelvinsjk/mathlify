<script lang="ts">
	...
	import { align, alignStar, alignatStar, display, eqn, gatherStar, math, newline } from 'mathlifier';
	...
	(() => {
		...
		(() => {
			...
			const solSubparts = [
				{body: `${math(`-\\frac{\\pi}{2} \\leqe x \\leq \\frac{\\pi}{2} \\; \\blacksquare`)}`},
				{body: `${math(`0 \\leqe x \\leq \\pi \\; \\blacksquare`)}`},
			];
