...
<style>
	...
	:global(.content section[role='doc-endnotes']),
	:global(.content .citation) {
		font-size: 0.75rem;
	}
	:global(.content .definition),
	:global(.content .technique),
	:global(.content .example),
	:global(.content .formula) {
	...
	:global(.content .definition:before) {
		content: 'Definition';
		position: absolute;
		top: 0.75em;
		font-weight: 700;
	...
	:global(.content .technique:before) {
		content: 'Technique';
		position: absolute;
		top: 0.75em;
		font-weight: 700;
	...
	:global(.content .technique > h2:first-child),
	:global(.content .example > h3:first-child) {
