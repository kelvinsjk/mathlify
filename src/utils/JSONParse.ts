 ...
 */
export function JSONParse(jsonString: string): string|number|boolean|Fraction|Term|Expression|Polynomial|(string|number|boolean|Fraction|Term|Expression|Polynomial)[] {
